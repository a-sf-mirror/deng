...
*/
    ...
    // Map data setup
    // These routines are called before any data is read
    ...
    void            (*SetupForThings) (int num);
    void            (*SetupForLines) (int num);
    void            (*SetupForSides) (int num);
    void            (*SetupForSectors) (int num);

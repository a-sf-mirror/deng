...
static const Control_t controls[] = {
    ...
    /*42 */ {"infoscreen", 0, DDBC_NORMAL, DDKEY_F1, 0, 0},
...
static const MenuItem_t ControlsItems[] = {
    ...
    {ITT_EFUNC, 0, "JUMP : ", SCControlConfig, 60 /*A_JUMP */ },
    ...
    {ITT_EFUNC, 0, "STAFF/GAUNTLETS :", SCControlConfig, A_WEAPON1},
    ...
    {ITT_EFUNC, 0, "INVENTORY LEFT :", SCControlConfig, 53},
    {ITT_EFUNC, 0, "INVENTORY RIGHT :", SCControlConfig, 54},
    {ITT_EFUNC, 0, "USE ARTIFACT :", SCControlConfig, A_USEARTIFACT},
    {ITT_EMPTY, 0, NULL, NULL, 0},
    {ITT_EMPTY, 0, "MENU", NULL, 0},
    {ITT_EFUNC, 0, "OPEN/CLOSE MENU :", SCControlConfig, 86},
    {ITT_EFUNC, 0, "Cursor Up :", SCControlConfig, 80},
    {ITT_EFUNC, 0, "Cursor Down :", SCControlConfig, 81},
    {ITT_EFUNC, 0, "Cursor Left :", SCControlConfig, 82},
    {ITT_EFUNC, 0, "Cursor Right :", SCControlConfig, 83},
    {ITT_EFUNC, 0, "Accept :", SCControlConfig, 84},
    {ITT_EFUNC, 0, "Cancel :", SCControlConfig, 85},
    {ITT_EMPTY, 0, "MENU HOTKEYS", NULL, 0},
    {ITT_EFUNC, 0, "INFO :", SCControlConfig, 42},
    {ITT_EFUNC, 0, "SOUND MENU :", SCControlConfig, 45},
    {ITT_EFUNC, 0, "LOAD GAME :", SCControlConfig, 43},
    {ITT_EFUNC, 0, "SAVE GAME :", SCControlConfig, 44},
    {ITT_EFUNC, 0, "QUICK LOAD :", SCControlConfig, 49},
    {ITT_EFUNC, 0, "QUICK SAVE :", SCControlConfig, 46},
    {ITT_EFUNC, 0, "END GAME :", SCControlConfig, 47},
    {ITT_EFUNC, 0, "QUIT :", SCControlConfig, 50},
    {ITT_EFUNC, 0, "MESSAGES ON/OFF:", SCControlConfig, 48},
    {ITT_EFUNC, 0, "GAMMA CORRECTION :", SCControlConfig, 51},
    {ITT_EFUNC, 0, "SPY MODE :", SCControlConfig, 52},
    {ITT_EMPTY, 0, NULL, NULL, 0},
    {ITT_EMPTY, 0, "SCREEN", NULL, 0},
    {ITT_EFUNC, 0, "SMALLER VIEW :", SCControlConfig, 56},
    {ITT_EFUNC, 0, "LARGER VIEW :", SCControlConfig, 55},
    {ITT_EFUNC, 0, "SMALLER STATBAR :", SCControlConfig, 58},
    {ITT_EFUNC, 0, "LARGER STATBAR :", SCControlConfig, 57},
    {ITT_EMPTY, 0, NULL, NULL, 0},

    {ITT_EMPTY, 0, "AUTOMAP", NULL, 0},
    {ITT_EFUNC, 0, "OPEN/CLOSE MAP :", SCControlConfig, 67},
    {ITT_EFUNC, 0, "PAN UP :", SCControlConfig, 76},
    {ITT_EFUNC, 0, "PAN DOWN :", SCControlConfig, 77},
    {ITT_EFUNC, 0, "PAN LEFT :", SCControlConfig, 78},
    {ITT_EFUNC, 0, "PAN RIGHT :", SCControlConfig, 79},
    {ITT_EFUNC, 0, "FOLLOW MODE :", SCControlConfig, 68},
    {ITT_EFUNC, 0, "ROTATE MODE :", SCControlConfig, 69},
    {ITT_EFUNC, 0, "TOGGLE GRID :", SCControlConfig, 70},
    {ITT_EFUNC, 0, "ZOOM IN :", SCControlConfig, 71},
    {ITT_EFUNC, 0, "ZOOM OUT :", SCControlConfig, 72},
    {ITT_EFUNC, 0, "ZOOM EXTENTS :", SCControlConfig, 73},
    {ITT_EFUNC, 0, "ADD MARK :", SCControlConfig, 74},
    {ITT_EFUNC, 0, "CLEAR MARKS :", SCControlConfig, 75},

    {ITT_EMPTY, 0, NULL, NULL, 0},
    {ITT_EMPTY, 0, "CHATMODE", NULL, 0},
    {ITT_EFUNC, 0, "OPEN CHAT :", SCControlConfig, 61},
    {ITT_EFUNC, 0, "GREEN CHAT :", SCControlConfig, 62},
    {ITT_EFUNC, 0, "YELLOW CHAT :", SCControlConfig, 63},
    {ITT_EFUNC, 0, "RED CHAT :", SCControlConfig, 64},
    {ITT_EFUNC, 0, "BLUE CHAT :", SCControlConfig, 65},
    {ITT_EFUNC, 0, "COMPLETE :", SCControlConfig, 88},
    {ITT_EFUNC, 0, "DELETE :", SCControlConfig, 100},
    {ITT_EFUNC, 0, "CANCEL CHAT :", SCControlConfig, 89},
    {ITT_EFUNC, 0, "MSG REFRESH :", SCControlConfig, 87},
    {ITT_EFUNC, 0, "MACRO 0:", SCControlConfig, 90},
    {ITT_EFUNC, 0, "MACRO 1:", SCControlConfig, 91},
    {ITT_EFUNC, 0, "MACRO 2:", SCControlConfig, 92},
    {ITT_EFUNC, 0, "MACRO 3:", SCControlConfig, 93},
    {ITT_EFUNC, 0, "MACRO 4:", SCControlConfig, 94},
    {ITT_EFUNC, 0, "MACRO 5:", SCControlConfig, 95},
    {ITT_EFUNC, 0, "MACRO 6:", SCControlConfig, 96},
    {ITT_EFUNC, 0, "MACRO 7:", SCControlConfig, 97},
    {ITT_EFUNC, 0, "MACRO 8:", SCControlConfig, 98},
    {ITT_EFUNC, 0, "MACRO 9:", SCControlConfig, 99},

    {ITT_EMPTY, 0, NULL, NULL, 0},
    {ITT_EMPTY, 0, "MISCELLANEOUS", NULL, 0},
    {ITT_EFUNC, 0, "SCREENSHOT :", SCControlConfig, 66},
    {ITT_EFUNC, 0, "PAUSE :", SCControlConfig, 59},
    {ITT_EFUNC, 0, "STOP DEMO :", SCControlConfig, A_STOPDEMO},
    {ITT_EFUNC, 0, "MESSAGE YES :", SCControlConfig, 101},
    {ITT_EFUNC, 0, "MESSAGE NO :", SCControlConfig, 102},
    {ITT_EFUNC, 0, "MESSAGE CANCEL :", SCControlConfig, 103}
};

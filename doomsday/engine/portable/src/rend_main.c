...
static void lightVertices(uint num, ColorRawf* colors, const rvertex_t* verts,
...
void Rend_VertexColorsGlow(ColorRawf* colors, uint num, float glow)
{
    size_t i;
    for(i = 0; i < num; ++i)
    {
...
void Rend_VertexColorsAlpha(ColorRawf* colors, uint num, float alpha)
{
    size_t i;
    for(i = 0; i < num; ++i)
    {
    ...
    else
    {
        ...
        else
        {
            ...
            if(surfaceColor[0] < 1 || surfaceColor[1] < 1 || surfaceColor[2] < 1)
            {
                ...
                lightVertices(numVertices, rcolors, rvertices, ll, vColor);
            }
            else
            {
                // Use sector light+color only.
                lightVertices(numVertices, rcolors, rvertices, ll, sectorLightColor);
            }
        }

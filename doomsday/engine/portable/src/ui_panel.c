...
ui_object_t ob_panel[] =
{
    ...
    { UI_TEXT,      0,  UIF_FADE_AWAY,  300, 70, 0, 55,     "Field Of View angle", UIText_Drawer },
    { UI_SLIDER,    0,  UIF_FADE_AWAY,  680, 70, 300, 55,   "",         UISlider_Drawer, UISlider_Responder, UISlider_Ticker, CP_CvarSlider, &sld_fov },
    { UI_BUTTON,    0,  0,              680, 130, 70, 60,   "90",       UIButton_Drawer, UIButton_Responder, 0, CP_QuickFOV },
    { UI_BUTTON,    0,  0,              755, 130, 70, 60,   "95",       UIButton_Drawer, UIButton_Responder, 0, CP_QuickFOV },
    { UI_BUTTON,    0,  0,              830, 130, 70, 60,   "100",      UIButton_Drawer, UIButton_Responder, 0, CP_QuickFOV },
    { UI_BUTTON,    0,  0,              905, 130, 70, 60,   "110",      UIButton_Drawer, UIButton_Responder, 0, CP_QuickFOV },
    { UI_TEXT,      0,  0,              300, 190, 0, 55,    "Mirror player weapon models", UIText_Drawer },
    { UI_BUTTON2,   0,  0,              680, 190, 70, 55,   "rend-model-mirror-hud", UIButton_Drawer, UIButton_Responder, 0, CP_CvarButton },

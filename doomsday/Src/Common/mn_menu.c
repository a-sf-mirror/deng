...
static MenuItem_t WeaponItems[] = {
    ...
    {ITT_LRFUNC, 0, "1 :", M_WeaponOrder, 0 << 9 },
    {ITT_LRFUNC, 0, "2 :", M_WeaponOrder, 1 << 9 },
    {ITT_LRFUNC, 0, "3 :", M_WeaponOrder, 2 << 9 },
    {ITT_LRFUNC, 0, "4 :", M_WeaponOrder, 3 << 9 },
    {ITT_LRFUNC, 0, "5 :", M_WeaponOrder, 4 << 9 },
    {ITT_LRFUNC, 0, "6 :", M_WeaponOrder, 5 << 9 },
    {ITT_LRFUNC, 0, "7 :", M_WeaponOrder, 6 << 9 },
    {ITT_LRFUNC, 0, "8 :", M_WeaponOrder, 7 << 9 },
    {ITT_LRFUNC, 0, "9 :", M_WeaponOrder, 8 << 9 },
    ...
    if(menu_alpha > 0)
    {
            ...
            i < max && i < currentMenu->firstItem + currentMenu->numVisItems; i++)
        {
            ...
            if(currentMenu->items[i].lumpname)
            {
                ...
                {
                    WI_DrawPatch(x, y + currentMenu->itemHeight -
...
#ifdef __JDOOM__
    M_WriteMenuText(menu, 15, yesno[berserkAutoSwitch != 0]);
#endif
}

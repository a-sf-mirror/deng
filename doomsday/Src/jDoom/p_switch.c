...
//
// $Log$
// Revision 1.3.2.1  2004/05/16 10:01:37  skyjake
...
/*	gi.conprintf( "P_ChangeSwitchTexture: line=%p (num %i), again:%i, t:%i, m:%i b:%i\n",
		line, line-lines, useAgain, texTop, texMid, texBot);*/
...
{               
	...
	if(XL_UseLine(line, side, thing)) return true;

...
void            P_MoveThingsOutOfWalls(struct gamemap_s* map);
#if __JHERETIC__
void            P_TurnGizmosAwayFromDoors(struct gamemap_s* map);
#endif

void            P_RebornPlayer(int plrNum);

boolean         P_CheckSpot(struct gamemap_s* map, float x, float y);
#endif

...
static boolean fuzzySpawnPosition(GameMap* map, float* x, float* y,
...
void GameMap_AddPlayerStart(GameMap* map, int defaultPlrNum, uint entryPoint,
...
void GameMap_ClearPlayerStarts(GameMap* map)
{
    assert(map);
    {
 ...
 */
const playerstart_t* GameMap_PlayerStart(GameMap* map, uint entryPoint, int pnum, boolean deathmatch)
{
    assert(map);
    {
#if __JHEXEN__
...
uint GameMap_NumPlayerStarts(GameMap* map, boolean deathmatch)
{
    assert(map);
    if(deathmatch)
 ...
 */
void GameMap_DealPlayerStarts(GameMap* map, uint entryPoint)
{
    assert(map);
    {
    int i;
 ...
 */
void GameMap_SpawnPlayer(GameMap* map, int plrNum, playerclass_t pClass,
...
static void spawnPlayer(GameMap* map, int plrNum, playerclass_t pClass,
                        float x, float y, float z, angle_t angle, int spawnFlags,
 ...
 */
void GameMap_SpawnPlayers(GameMap* map)
{
    assert(map);
 ...
 */
void GameMap_SpawnPlayerDM(GameMap* map, int playerNum)
{
    assert(map);
    {
